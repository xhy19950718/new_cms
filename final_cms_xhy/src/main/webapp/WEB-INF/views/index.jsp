...
<body>
	...
	<div class="container-fluid row">
		...
		<div class="col-sm-6 row" style="margin-top:10px">
			<input type="text" class="form-control col-10" name="key" id="key">
			<input type="button" class="btn btn-primary col-2" value="搜索" onclick="search()" >
	...
	<script type="text/javascript">
		...
		function search(){
			location="/search/search?key="+$("#key").val();
		}
	</script>
</body>
</html>